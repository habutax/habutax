...
class Form8606(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            BooleanField('qualified_disaster_distributions', description=f'Are any of {your} distributions from traditional, SEP, and Simple IRAs in 2021 qualified disaster distributions?'),
