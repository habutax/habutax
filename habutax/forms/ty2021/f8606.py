...
class Form8606(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            BooleanInput('distribution_or_roth_conversion', description=f'In {tax_year}, did {you} take a distribution from traditional, SEP, or SIMPLE IRAs, or make a Roth IRA conversion?'),
            ...
            BooleanInput('part_2_needed', description=f'Did {you} convert part or all of {your} traditional, SEP, and SIMPLE IRAs to a Roth IRA in {tax_year}?'),
            FloatInput('converted_cost_basis', description=f'Enter {your} cost basis for the net amount {you} converted from traditional, SEP, and SIMPLE IRAs to Roth IRAs in {tax_year}'),
        ...
        optional_fields = [
            SimpleField('1', lambda s, i, v: i['nondeductible_contributions']),
            SimpleField('2', lambda s, i, v: i['traditional_basis']),
            SimpleField('3', lambda s, i, v: v['1'] + v['2']),
            SimpleField('4', lambda s, i, v: i['nondeductible_contributions_next_year']),
            SimpleField('5', lambda s, i, v: v['3'] - v['4']),
            SimpleField('6', lambda s, i, v: i['year_end_value_non_roth']),
            SimpleField('7', lambda s, i, v: i['distributions_2021']),
            SimpleField('8', lambda s, i, v: i['net_converted']),
            SimpleField('9', lambda s, i, v: v['6'] + v['7'] + v['8']),
            SimpleField('10', lambda s, i, v: min(1.000, float(v['5']) / float(v['9']), 1.000)),
            SimpleField('11', lambda s, i, v: v['8'] * v['10']),
            SimpleField('12', lambda s, i, v: v['7'] * v['10']),
            SimpleField('13', lambda s, i, v: v['11'] + v['12']),
            SimpleField('14', lambda s, i, v: v['3'] if i['distribution_or_roth_conversion'] else v['3'] - v['13']),
            SimpleField('15a', lambda s, i, v: v['7'] - v['12']),
            SimpleField('15b', lambda s, i, v: self.not_implemented() if i['qualified_disaster_distributions'] else 0.0),
            SimpleField('15c', lambda s, i, v: v['15a'] - v['15b']),
            SimpleField('16', lambda s, i, v: i['net_converted']),
            SimpleField('17', lambda s, i, v: v['11'] if i['part_1_needed'] else i['converted_cost_basis']),
            SimpleField('18', lambda s, i, v: v['16'] - v['17']),
            SimpleField('19', lambda s, i, v: i['total_nonqualified_distributions']),
            SimpleField('20', lambda s, i, v: i['qualified_homebuyer']),
            SimpleField('21', lambda s, i, v: max(0.0, v['19'] - v['20'])),
            SimpleField('22', lambda s, i, v: i['roth_ira_contributions_basis']),
            SimpleField('23', lambda s, i, v: max(0.0, v['21'] - v['22'])),
        ]
        ...
        required_fields = [
            SimpleField('taxable_amount', taxable_amount),
        ]
