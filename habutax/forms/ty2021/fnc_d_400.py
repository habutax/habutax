...
class FormNCD400(Form):
    ...
    def __init__(self, **kwargs):
        ...
        required_fields = [
            ...
            FloatField('6', lambda s, i, v: v['1040.11']),
            FloatField('7', lambda s, i, v: v['nc_d-400_ss.15'] if i['additions_to_agi'] else None),
            FloatField('8', lambda s, i, v: v['6'] + v['7']),
            FloatField('9', lambda s, i, v: v['nc_d-400_ss.38'] if i['deductions_from_agi'] else None),
            IntegerField('10a', lambda s, i, v: v['nc_d-400_child_deduction_wkst.3']),
            FloatField('10b', lambda s, i, v: v['nc_d-400_child_deduction_wkst.5'] if v['10a'] > 0 else None),
            BooleanField('11_itemizing', lambda s, i, v: i['try_itemizing'] and v['nc_d-400_sa.deduction'] > v['nc_d-400_sa.nc_standard_deduction']),
            FloatField('11', lambda s, i, v: v['nc_d-400_sa.deduction'] if v['11_itemizing'] else v['nc_d-400_sa.nc_standard_deduction']),
            FloatField('12a', lambda s, i, v: v['9'] + v['10b'] + v['11']),
            FloatField('12b', lambda s, i, v: v['8'] - v['12a']),
            FloatField('13', lambda s, i, v: s.not_implemented() if i['partial_year_or_nonresident'] else None),
            FloatField('14', lambda s, i, v: s.not_implemented() if i['partial_year_or_nonresident'] else v['12b']),
            FloatField('15', lambda s, i, v: v['14'] * 0.0525), # NC Income Tax
            FloatField('16', lambda s, i, v: s.not_implemented() if i['nc_tax_credits'] else None),
            FloatField('17', lambda s, i, v: v['15'] - v['16']),
            BooleanField('no_consumer_use_tax', lambda s, i, v: i['no_consumer_use_tax']),
            FloatField('18', lambda s, i, v: None if v['no_consumer_use_tax'] else v['nc_d-400_consumer_use_tax_wkst.consumer_use_tax']),
            FloatField('19', lambda s, i, v: v['17'] + v['18']),
            FloatField('20a', your_tax_withheld),
            FloatField('20b', spouses_tax_withheld),
            FloatField('21a', lambda s, i, v: i['estimated_tax']),
            FloatField('21b', lambda s, i, v: i['paid_with_extension']),
            FloatField('21c', lambda s, i, v: i['partnership_payments']),
            FloatField('21d', lambda s, i, v: i['s_corp_payments']),
            FloatField('22', lambda s, i, v: s.not_implemented() if i['amended_return'] else None),
            FloatField('23', lambda s, i, v: v['20a'] + v['20b'] + v['21a'] + v['21b'] + v['21c'] + v['21d'] + v['22']),
            FloatField('24', lambda s, i, v: s.not_implemented() if i['amended_return'] else None),
            FloatField('25', lambda s, i, v: v['23'] - v['24']),
            FloatField('refund', lambda s, i, v: v['34'] if v['19'] <= v['25'] else -v['27']), # Fake "field" to ensure only correct portion is filled
        ]

        optional_fields = [
            # Tax due
            FloatField('26a', lambda s, i, v: v['19'] - v['25'] if v['19'] > v['25'] else s.not_implemented()),
            FloatField('26b', lambda s, i, v: s.not_implemented() if i['late'] else None),
            FloatField('26c', lambda s, i, v: s.not_implemented() if i['late'] else None),
            FloatField('26d', lambda s, i, v: v['26b'] + v['26c']),
            FloatField('26e', lambda s, i, v: i['interest_on_underpayment'] if (v['17'] - (v['20a'] + v['20b']) >= 1000) else None),
            FloatField('27', lambda s, i, v: v['26a'] + v['26d'] + v['26e']),

            # Overpayment
            FloatField('28', lambda s, i, v: v['25'] - v['19'] if v['19'] <= v['25'] else s.not_implemented()),
            FloatField('29', lambda s, i, v: i['2022_estimated_income_tax']),
            FloatField('30', lambda s, i, v: i['nc_nongame_endangered_wildlife']),
            FloatField('31', lambda s, i, v: i['nc_education_endowment']),
            FloatField('32', lambda s, i, v: i['nc_breast_cervical_cancer']),
            FloatField('33', lambda s, i, v: v['29'] + v['30'] + v['31'] + v['32']),
            FloatField('34', lambda s, i, v: v['28'] - v['33'] if v['28'] >= v['33'] else s.not_implemented()),
        ]
