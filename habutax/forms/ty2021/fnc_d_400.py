...
class FormNCD400(Form):
    ...
    def __init__(self, **kwargs):
        ...
        required_fields = [
            ...
            StringField('spouse_ssn', lambda s, i, v: i['1040.spouse_ssn'][:3] + "-" + i['1040.spouse_ssn'][3:5] + "-" + i['1040.spouse_ssn'][5:] if i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly else None),
            ...
            StringField('spouse_first_name', lambda s, i, v: i['1040.spouse_first_name'].upper() if i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly else None),
            StringField('spouse_middle_initial', lambda s, i, v: i['1040.spouse_middle_initial'].upper() if i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly else None),
            StringField('spouse_last_name', lambda s, i, v: i['1040.spouse_last_name'].upper() if i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly else None),
            ...
            BooleanField('spouse_veteran', lambda s, i, v: i['spouse_veteran'] if i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly else None),
            BooleanField('federal_extension', lambda s, i, v: i['federal_extension']),
            BooleanField('1', lambda s, i, v: i['1040.filing_status'] == enum.filing_status_2021.Single),
            BooleanField('2', lambda s, i, v: i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingJointly),
            BooleanField('3', lambda s, i, v: i['1040.filing_status'] == enum.filing_status_2021.MarriedFilingSeparately),
            BooleanField('4', lambda s, i, v: i['1040.filing_status'] == enum.filing_status_2021.HeadOfHousehold),
            BooleanField('5', lambda s, i, v: i['1040.filing_status'] == enum.filing_status_2021.QualifyingWidowWidower),
