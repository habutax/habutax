...
class FormNCD400(Form):
    ...
    tax_year = 2022
    description = "D-400"
    long_description = "N.C. 2022 Individual Income Tax Return"
    jurisdiction = Jurisdiction.NC
    sequence_no = 0

    def __init__(self, **kwargs):
        inputs = [
            StringInput('county', description="Enter the North Carolina county in which you resided on the last day of 2022. Your county of residence may be different than the county of your mailing address."),
            ...
            BooleanInput('nc_residents', description="Were you, and your spouse if filing jointly, residents of N.C. for the entire year of 2022?"),
            BooleanInput('veteran', description="Are you a veteran?"),
            BooleanInput('spouse_veteran', description="Is your spouse a veteran?"),
            BooleanInput('federal_extension', description="Were you granted an automatic extension to file your 2022 federal income tax return, e.g., Form 1040?"),
            ...
            FloatInput('estimated_tax', description="Enter any estimated North Carolina income tax payments for tax year 2022 (including any portion of your 2020 refund that was applied to your 2022 estimated income tax)."),
        ...
        required_fields = [
            ...
            FloatField('15', lambda s, i, v: v['14'] * 0.0499, places=0), # NC Income Tax
