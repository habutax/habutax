...
class Form8889(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            BooleanInput('hdhp_plan_family', description=f'Were you covered under a *family* high-deductible health plan (HDHP) during 2022 (as opposed to self-only coverage)? If {you} were covered, or considered covered, by a self-only high-deductible health plan (HDHP) and a family HDHP at different times during the year, answer "yes" only if the family plan was in effect for a longer period. If {you} were covered by both a self-only HDHP and a family HDHP at the same time, {you} are treated as having family coverage during that period. If, on the first day of the last month of {your} tax year (December 1 for most taxpayers), {you} had family coverage, answer "yes". Were you covered under a high-deductible *family* plan during 2022?'),
            FloatInput('hsa_contributions', description=f'Enter HSA contributions {you} made for 2022 (or those made on {your} behalf), including those made from January 1, 2022, through April 15, 2022, that were for 2022. Do not include employer contributions, contributions through a cafeteria plan, or rollovers. See instructions for Form 8889, line 2.'),
            BooleanInput('age_under_55', description=f'Were {you} under the age of 55 at the end of 2022?'),
            BooleanInput('hsa_full_year', description=f'Did {you} have a HDHP medical plan for the first day of every month during the 2022 year?'),
            FloatInput('archer_msa', description=f'Enter the amount {you} and {your} employer contributed to {your} Archer MSAs for 2022 from Form 8853, lines 1 and 2. If you or your spouse had family coverage under an HDHP at any time during 2022, also include any amount contributed to {your_spouses} Archer MSAs'),
            ...
            FloatInput('employer_contribution', description=f'Employer contributions made to {your} HSAs for 2022? NOTE: This number should match the sum of all {your} your forms W-2, box 12, code W.'),
        ]

        def calc_contribution_max(self, i, v):
            if i['age_under_55'] and i['hsa_full_year']:
                return 7300 if v['1'] else 3650
            else:
