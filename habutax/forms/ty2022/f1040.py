...
class Form1040(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            BooleanInput('digital_assets', description="At any time during 2022, did you: (a) receive (as a reward, award, or payment for property or services); or (b) sell, exchange, gift, or otherwise dispose of a digital asset (or a financial interest in a digital asset)? (See Form 1040 instructions)"),
            IntegerInput('number_dependents', description="How many dependents can you claim for 2022? (See Form 1040 instructions)"),
            ...
            BooleanInput('schedule_1_additional_income', description="Do you need to report additional income on Schedule 1? This includes prior year tax refunds paid in 2022, alimony received, unemployment compensation, and more. See the instructions for Schedule 1 for Form 1040 if you are not sure."),
            BooleanInput('schedule_1_income_adjustments', description="Do you need to report adjustments to income on Schedule 1? This includes educator expenses, any HSA contributions you or your spouse made in 2022, self-employment tax, IRA deductions, student loan interest deductions, and more. See the instructions for Schedule 1 for Form 1040 if you are not sure."),
            ...
            BooleanInput('need_8962', description="If you, your spouse with whom you are filing a joint return, or your dependent was enrolled in health insurance coverage purchased from the Marketplace, were advance payments of the premium tax credit made for the coverage in 2022?"),
            ...
            FloatInput('estimated_tax_payments', description="Enter the total of any 2022 estimated tax payments and amount applied from your 2020 return."),
            ...
            BooleanInput('rrta_compensation', description="Do you (or your spouse if married filing jointly) have any Railroad Retirement Tax Act compensation to report for 2022?"),
            BooleanInput('form_4797', description="Did you sell business property in 2022 or otherwise need to file Form 4797?"),
            BooleanInput('postsecondary_education_expenses', description="Did you pay any qualified education expenses to an eligible postsecondary educational institution in 2022? See instructions for Schedule 3, line 3 and Form 8863 for more information"),
        ...
        def line_13(self, i, v):
            ...
            if i['filing_status'] is statuses.MarriedFilingJointly:
                income_limit = 340100.00
            else:
                income_limit = 170050.00
        ...
        pdf_fields = [
            ButtonPDFField('topmostSubform[0].Page1[0].c1_01[0]', 'filing_status', '1', value_fn=lambda s, v, f: v == f.enum().Single),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_01[1]', 'filing_status', '2', value_fn=lambda s, v, f: v == f.enum().MarriedFilingJointly),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_01[2]', 'filing_status', '3', value_fn=lambda s, v, f: v == f.enum().MarriedFilingSeparately),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_01[3]', 'filing_status', '4', value_fn=lambda s, v, f: v == f.enum().HeadOfHousehold),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_01[4]', 'filing_status', '5', value_fn=lambda s, v, f: v == f.enum().QualifyingSurvivingSpouse),
#            TextPDFField('topmostSubform[0].Page1[0].f1_01[0]', 'other_spouse_dependent'),
            ...
            TextPDFField('topmostSubform[0].Page1[0].Address[0].f1_14[0]', 'foreign_province'),
            ...
            ButtonPDFField('topmostSubform[0].Page1[0].c1_04[0]', 'digital_assets', '1'),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_04[1]', 'digital_assets', '2', value_fn=lambda s, v, f: not v),
...
#            ButtonPDFField('topmostSubform[0].Page1[0].Dependents_ReadOrder[0].c1_12[0]', 'more_than_4_dependents', '1'),
            ...
            TextPDFField('topmostSubform[0].Page1[0].f1_28[0]', '1a'),
            TextPDFField('topmostSubform[0].Page1[0].f1_29[0]', '1b'),
            TextPDFField('topmostSubform[0].Page1[0].f1_30[0]', '1c'),
            TextPDFField('topmostSubform[0].Page1[0].f1_31[0]', '1d'),
            TextPDFField('topmostSubform[0].Page1[0].f1_32[0]', '1e'),
            TextPDFField('topmostSubform[0].Page1[0].f1_33[0]', '1f'),
            TextPDFField('topmostSubform[0].Page1[0].f1_34[0]', '1g'),
            TextPDFField('topmostSubform[0].Page1[0].f1_35[0]', '1h'),
            TextPDFField('topmostSubform[0].Page1[0].f1_36[0]', '1i'),
            TextPDFField('topmostSubform[0].Page1[0].f1_37[0]', '1z'),
            TextPDFField('topmostSubform[0].Page1[0].f1_38[0]', '2a'),
            TextPDFField('topmostSubform[0].Page1[0].f1_39[0]', '2b'),
            TextPDFField('topmostSubform[0].Page1[0].f1_40[0]', '3a'),
            TextPDFField('topmostSubform[0].Page1[0].f1_41[0]', '3b'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_42[0]', '4a'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_43[0]', '4b'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_44[0]', '5a'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_45[0]', '5b'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_46[0]', '6a'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_47[0]', '6b'),
            ButtonPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].c1_21[0]', 'unknown', '1'),
            ButtonPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].c1_22[0]', 'unknown', '1'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_48[0]', '7'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_49[0]', '8'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_50[0]', '9'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_51[0]', '10'),
            TextPDFField('topmostSubform[0].Page1[0].Lines4a-11_ReadOrder[0].f1_52[0]', '11'),
            TextPDFField('topmostSubform[0].Page1[0].StandardDeductionBubble[0].f1_53[0]', '12'),
            TextPDFField('topmostSubform[0].Page1[0].f1_54[0]', '13'),
            TextPDFField('topmostSubform[0].Page1[0].f1_55[0]', '14'),
            TextPDFField('topmostSubform[0].Page1[0].f1_56[0]', '15'),
            ButtonPDFField('topmostSubform[0].Page2[0].c2_01[0]', 'unknown', '1'),
            ButtonPDFField('topmostSubform[0].Page2[0].c2_02[0]', 'unknown', '1'),
            ButtonPDFField('topmostSubform[0].Page2[0].c2_03[0]', 'unknown', '1'),
            TextPDFField('topmostSubform[0].Page2[0].f2_01[0]', 'unknown'),
...
#            ButtonPDFField('topmostSubform[0].Page2[0].c2_04[0]', 'form_8888', '1'),
            ...
            ButtonPDFField('topmostSubform[0].Page2[0].c2_05[0]', '35c', '1'),
            ButtonPDFField('topmostSubform[0].Page2[0].c2_05[1]', '35c', '2', value_fn=lambda s, v, f: not v),
            ...
            ButtonPDFField('topmostSubform[0].Page2[0].c2_06[0]', 'designee', '1'),
            ButtonPDFField('topmostSubform[0].Page2[0].c2_06[1]', 'designee', '2', value_fn=lambda s, v, f: not v),
...
#            ButtonPDFField('topmostSubform[0].Page2[0].c2_07[0]', 'preparer_self-employed', '1'),
