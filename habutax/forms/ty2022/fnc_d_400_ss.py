...
class FormNCD400SS(Form):
    ...
    def __init__(self, **kwargs):
        ...
        optional_fields = [
            ...
            FloatField('23a', lambda s, i, v: i['bonus_depreciation_2017'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23b', lambda s, i, v: i['bonus_depreciation_2018'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23c', lambda s, i, v: i['bonus_depreciation_2019'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23d', lambda s, i, v: i['bonus_depreciation_2020'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23e', lambda s, i, v: i['bonus_depreciation_2021'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23f', lambda s, i, v: v['22a'] + v['22b'] + v['22c'] + v['22d'] + v['22e'], places=0),
            FloatField('24a', lambda s, i, v: i['section_179_expense_2017'] if i['section_179_expense'] else None, places=0),
            FloatField('24b', lambda s, i, v: i['section_179_expense_2018'] if i['section_179_expense'] else None, places=0),
            FloatField('24c', lambda s, i, v: i['section_179_expense_2019'] if i['section_179_expense'] else None, places=0),
            FloatField('24d', lambda s, i, v: i['section_179_expense_2020'] if i['section_179_expense'] else None, places=0),
            FloatField('24e', lambda s, i, v: i['section_179_expense_2021'] if i['section_179_expense'] else None, places=0),
            FloatField('24f', lambda s, i, v: v['23a'] + v['23b'] + v['23c'] + v['23d'] + v['23e'], places=0),
