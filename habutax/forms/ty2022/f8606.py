...
class Form8606(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            FloatInput('nondeductible_contributions', description=f'Enter {your} nondeductible contributions to traditional IRAs for 2022, including those made for 2022 from January 1, 2022, through April 18, 2022'),
            ...
            FloatInput('nondeductible_contributions_next_year', description=f'Enter {your} nondeductible contributions to traditional IRAs for 2022 made from January 1, 2022 through April 18, 2022'),
