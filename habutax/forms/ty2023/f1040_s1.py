...
class Form1040S1(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            BooleanInput('certain_business_expenses', description='Did you incurr any of the following expenses in 2023: Certain business expenses of National Guard and reserve members who traveled more than 100 miles from home to perform services as a National Guard or reserve member; Performing-arts-related expenses as a qualified performing artist; Business expenses of fee-basis state or local government officials. For more details, see Form 2106.'),
            BooleanInput('moving_expenses', description='Did you have any moving expenses as a member of the Armed Forces on active duty and due to a military order you move because of a permanent change of station in 2023? See form 3903 and Tax Topic 455.'),
            BooleanInput('deductible_self_employment_tax', description='Were you self-employed and did you self-employment tax in 2023? See Form 1040, Schedule SE.'),
            BooleanInput('sep_simple_qualified', description="Were you self-employed and eligible to deduct any contributions to SEP, SIMPLE, or Qualified Plans in 2023?"),
            ...
            FloatInput('traditional_ira_deduction', description="If you (and/or your spouse if filing jointly) are eligible to take a deduction for contributions to a traditional IRA made in 2023, enter that amount here. See instructions for Form 1040, Schedule 1, line 20 for more information"),
