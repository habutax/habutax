...
class Form1040SA(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            FloatInput('state_local_real_estate_taxes', description="Enter the sum of any state and local taxes you paid in 2023 (either directly or through your mortgage company) on real estate you own that wasn't used for business. See instructions for Form 1040, Schedule A, line 5b for details of what can and cannot be claimed."),
            FloatInput('state_local_personal_property_taxes', description="Enter the sum of any state and local personal property taxes you paid in 2023, but only if the taxes were based on value alone and were imposed on a yearly basis. If you paid a yearly fee for the registration of your car and part of that fee was based on the car's value and part was based on its weight, you can deduct only the part of the fee that was based on the car's value."),
