...
#            TextPDFField('topmostSubform[0].Page1[0].f1_03[0]', 'tax_year_20xx', max_length=2),
            ...
            ButtonPDFField('topmostSubform[0].Page1[0].c1_3[1]', 'filing_status', '2', value_fn=lambda s, v, f: v == f.enum().MarriedFilingJointly),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_3[2]', 'filing_status', '3', value_fn=lambda s, v, f: v == f.enum().MarriedFilingSeparately),
            ButtonPDFField('topmostSubform[0].Page1[0].c1_3[3]', 'filing_status', '4', value_fn=lambda s, v, f: v == f.enum().HeadOfHousehold),
...
#            ButtonPDFField('topmostSubform[0].Page1[0].Dependents_ReadOrder[0].c1_12[0]', 'more_than_4_dependents', '1'),
            ...
            ButtonPDFField('topmostSubform[0].Page1[0].Table_Dependents[0].Row4[0].c1_19[0]', 'dependent_0_ctc', '1'),
            ButtonPDFField('topmostSubform[0].Page1[0].Table_Dependents[0].Row4[0].c1_20[0]', 'dependent_0_odc', '1'),
