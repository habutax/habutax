...
class FormNCD400SS(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            FloatInput('net_operating_loss_deduction', description="If you deduct a net operating loss from another year on your 2022 federal return, an addition is required for the amount of net operating loss deducted and not absorbed during tax year 2022 that will be carried forward to subsequent years. Enter any amount here (this isn't common)."),
            ...
            FloatInput('529_contributions_wrong_purpose', description="If you took a state tax deduction for contributions made to the N.C. 529 Plan while the deduction was in effect (taxable years beginning on or after January 1, 2006 and before January 1, 2014), and in tax year 2022, you withdrew funds from the plan, enter on Line 9 the amount you deducted in prior tax years to the extent the funds withdrawn were not used for a purpose allowed under IRC section 529."),
            FloatInput('cancelled_residence_debt', description="Enter the amount of qualified principal residence debt discharged in 2022 excluded from federal gross income under IRC section 108."),
            ...
            FloatInput('expenses_allocable_exempt', description="Enter all expenses allocable to income that is either wholly excluded from federal gross income or wholly exempt from North Carolina income tax to the extent those expenses are excluded from federal adjusted gross income"),
            ...
            FloatInput('taxed_pass_through_entity_loss', description="If you are a shareholder or a partner in a Taxed PTE, enter your share of North Carolina loss from the Taxed PTE (otherwise leave blank)"),
            ...
            BooleanInput('bonus_depreciation', description="Did you have any bonus depreciation deduction added to the federal adjusted gross income on your 2018, 2019, 2020, 2021 or 2022 state tax returns?"),
            ...
            FloatInput('bonus_depreciation_2021', description="You may enter an amount to deduct from your NC taxable income equal to 20% of the bonus depreciation deduction added to federal adjusted gross income on your 2021 state tax returns."),
            FloatInput('bonus_depreciation_2022', description="You may enter an amount to deduct from your NC taxable income equal to 20% of the bonus depreciation deduction added to federal adjusted gross income on your 2022 state tax returns."),
            BooleanInput('section_179_expense', description="Did you have any IRC section 179 expense deductions added to federal adjusted gross income on your 2018, 2019, 2020, 2021, or 2022 state tax returns?"),
            ...
            FloatInput('section_179_expense_2021', description="Enter 20% of the IRC section 179 expense deduction added to federal adjusted gross income on your 2021 state tax return, if any."),
            FloatInput('section_179_expense_2022', description="Enter 20% of the IRC section 179 expense deduction added to federal adjusted gross income on your 2022 state tax return, if any."),
            ...
            FloatInput('indian_tribe_exempt_income', description="Enter any income from 2022 which was earned or received by an enrolled member of any federally recognized Indian tribe and was derived from activities on any federally recognized Indian reservation while the member resides on the reservation. Income from intangibles having a situs on the reservation and retirement income associated with activities on the reservation are considered income derived from activities on the reservation."),
            FloatInput('state_basis_exceeds_federal', description="Enter any amount by which the NC state basis exceeded the federal cost basis for property disposed of in 2022."),
            ...
            FloatInput('certain_nc_grants', description="You may deduct the amount of the Extra Credit Grant or Business Recovery Grant payment you received in tax year 2022 to the extent the payment is included in calculating federal adjusted gross income. Enter any such amount here."),
            ...
            FloatInput('taxed_pass_through_income', description="If you are a shareholder or a partner in a Taxed Pass-Through Entity (PTE), enter your share of North Carolina income from the Taxed PTE"),
            BooleanInput('nc_net_operating_loss', description="Is it possible you qualify to claim a N.C Net Operating Loss? (this is not currently supported by HabuTax)"),
        ]
        ...
        optional_fields = [
            ...
            FloatField('12', lambda s, i, v: i['expenses_allocable_exempt'], places=0),
            FloatField('13', lambda s, i, v: i['discharged_student_debt'], places=0),
            FloatField('14', lambda s, i, v: i['taxed_pass_through_entity_loss'], places=0),
            FloatField('15', lambda s, i, v: 0.0, places=0), # "reserved for future use"
            FloatField('16', lambda s, i, v: sum([v[f'{f}'] for f in range(1, 16)]), places=0), # total additions to federal AGI
            ...
            # through 38.
            FloatField('17', lambda s, i, v: i['state_local_refund'], places=0),
            FloatField('18', lambda s, i, v: i['interest_us_obligations'], places=0),
            FloatField('19', lambda s, i, v: i['social_security_rrta'], places=0),
            FloatField('20', lambda s, i, v: i['bailey_settlement'], places=0),
            FloatField('21', lambda s, i, v: i['certain_military_retirement'], places=0),
            FloatField('22', lambda s, i, v: i['bonus_asset_basis'], places=0),
            FloatField('23a', lambda s, i, v: i['bonus_depreciation_2018'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23b', lambda s, i, v: i['bonus_depreciation_2019'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23c', lambda s, i, v: i['bonus_depreciation_2020'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23d', lambda s, i, v: i['bonus_depreciation_2021'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23e', lambda s, i, v: i['bonus_depreciation_2022'] if i['bonus_depreciation'] else None, places=0),
            FloatField('23f', lambda s, i, v: v['23a'] + v['23b'] + v['23c'] + v['23d'] + v['23e'], places=0),
            FloatField('24a', lambda s, i, v: i['section_179_expense_2018'] if i['section_179_expense'] else None, places=0),
            FloatField('24b', lambda s, i, v: i['section_179_expense_2019'] if i['section_179_expense'] else None, places=0),
            FloatField('24c', lambda s, i, v: i['section_179_expense_2020'] if i['section_179_expense'] else None, places=0),
            FloatField('24d', lambda s, i, v: i['section_179_expense_2021'] if i['section_179_expense'] else None, places=0),
            FloatField('24e', lambda s, i, v: i['section_179_expense_2022'] if i['section_179_expense'] else None, places=0),
            FloatField('24f', lambda s, i, v: v['24a'] + v['24b'] + v['24c'] + v['24d'] + v['24e'], places=0),
            FloatField('25', lambda s, i, v: i['section_1400z-2_gain'], places=0),
            FloatField('26', lambda s, i, v: i['nc_obligations_disposition'], places=0),
            FloatField('27', lambda s, i, v: i['indian_tribe_exempt_income'], places=0),
            FloatField('28', lambda s, i, v: i['state_basis_exceeds_federal'], places=0),
            FloatField('29', lambda s, i, v: i['business_expense_disallowed'], places=0),
            FloatField('30', lambda s, i, v: i['personal_education_savings'], places=0),
            FloatField('31', lambda s, i, v: i['state_emergency_disaster'], places=0),
            FloatField('32', lambda s, i, v: i['certain_economic_incentive'], places=0),
            FloatField('33', lambda s, i, v: i['certain_nc_grants'], places=0),
            FloatField('34', lambda s, i, v: i['certain_net_operating_loss_carrybacks'], places=0),
            FloatField('35', lambda s, i, v: i['certain_net_operating_loss_carryforward'], places=0),
            FloatField('36', lambda s, i, v: i['excess_business_loss'], places=0),
            FloatField('37', lambda s, i, v: i['business_interest_limitation'], places=0),
            FloatField('38', lambda s, i, v: i['taxed_pass_through_income'], places=0),
            FloatField('39', lambda s, i, v: s.not_implemented() if i['nc_net_operating_loss'] else None, places=0),
            FloatField('40', lambda s, i, v: 0.0, places=0), # "reserved for future use"
            # Add Lines 17 through 22, 23f, 24f, and 25 through 38
            FloatField('41', lambda s, i, v: sum([v[f'{f}'] for f in range(17, 23)]) + v['23f'] + v['24f'] + sum([v[f'{f}'] for f in range(25, 41)]), places=0),
        ]
...
#            TextPDFField('y_d400wf_reserved1', '15_reserved_for_future_use', max_length=32),
#            TextPDFField('y_d400schswf_li15_good', '15', max_length=8),
            ...
            TextPDFField('y_d400schswf_li22_good', '22', max_length=8),
            ...
            TextPDFField('y_d400schswf_li24a_good', '24a', max_length=8),
            TextPDFField('y_d400schswf_li24b_good', '24b', max_length=8),
            TextPDFField('y_d400schswf_li24c_good', '24c', max_length=8),
            TextPDFField('y_d400schswf_li24d_good', '24d', max_length=8),
            TextPDFField('y_d400schswf_li24e_good', '24e', max_length=8),
            TextPDFField('y_d400schswf_li24f_good', '24f', max_length=8),
            ...
            TextPDFField('y_d400schswf_li39_good', '39', max_length=8),
#            TextPDFField('y_d400wf_reserved2', '40_reserved_for_future_use', max_length=32),
#            TextPDFField('y_d400schswf_li40_good', '40', max_length=8),
            TextPDFField('y_d400schswf_li41_good', '41', max_length=8),
        ]
