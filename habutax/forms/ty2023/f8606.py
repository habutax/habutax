...
class Form8606(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            BooleanInput('part_1_needed', description=f'Do {you} need to fill out part 1 of Form 8606? This is required if one or more of the following apply: 1) {you} made nondeductible contributions to a traditional IRA for 2023, 2) {you} took distributions from a traditional, SEP, or SIMPLE IRA in 2023 and {you} made nondeductible contributions to a traditional IRA in 2023 or an earlier year, 3) {you} converted part, but not all, of {your} traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2023 and {you} made nondeductible contributions to a traditional IRA in 2023 or an earlier year. See Form 8606 instructions for more information.'),
            FloatInput('nondeductible_contributions', description=f'Enter {your} nondeductible contributions to traditional IRAs for 2023, including those made for 2023 from January 1, 2024, through April 18, 2024'),
            ...
            FloatInput('nondeductible_contributions_next_year', description=f'Enter {your} nondeductible contributions to traditional IRAs for 2023 made from January 1, 2024 through April 18, 2024'),
            FloatInput('year_end_value_non_roth', description=f'Enter the value of *all* {your} traditional, SEP, and SIMPLE IRAs as of December 31, 2023, plus any outstanding rollovers. Subtract any repayments of qualified disaster distributions (see 2023 Forms 8915-D and 8915-F)'),
            FloatInput('distributions_2023', description=f'Enter {your} distributions from traditional, SEP, and SIMPLE IRAs in 2023. Do *not* include rollovers (other than repayments of qualified disaster distributions (see 2023 Forms 8915-D and 8915-F)), qualified charitable distributions, a one-time distribution to fund an HSA, conversions to a Roth IRA, certain returned contributions, or recharacterizations of traditional IRA contributions (see instructions)'),
            BooleanInput('qualified_disaster_distributions', description=f'Are any of {your} distributions from traditional, SEP, and Simple IRAs in 2023 qualified disaster distributions?'),
            FloatInput('net_converted', description=f'Enter the net amount {you} converted from traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2023.'),
            ...
            BooleanInput('part_3_needed', description=f'Did {you} take a distribution from a Roth IRA in 2023?'),
            FloatInput('total_nonqualified_distributions', description=f'Enter {your} total nonqualified distributions from Roth IRAs in 2023, including any qualified first-time homebuyer distributions, and any qualified disaster distributions (see instructions). Also, see 2023 Forms 8915-D and 8915-F'),
        ...
        optional_fields = [
            ...
            FloatField('7', lambda s, i, v: i['distributions_2023']),
