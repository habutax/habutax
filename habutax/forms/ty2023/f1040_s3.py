...
class Form1040S3(Form):
    ...
    def __init__(self, **kwargs):
        ...
        pdf_fields = [
            ...
            TextPDFField('topmostSubform[0].Page1[0].f1_07[0]', '5a'),
            TextPDFField('topmostSubform[0].Page1[0].f1_08[0]', '5b'),
            TextPDFField('topmostSubform[0].Page1[0].f1_09[0]', '6a'),
            TextPDFField('topmostSubform[0].Page1[0].f1_10[0]', '6b'),
            TextPDFField('topmostSubform[0].Page1[0].f1_11[0]', '6c'),
            TextPDFField('topmostSubform[0].Page1[0].f1_12[0]', '6d'),
            TextPDFField('topmostSubform[0].Page1[0].f1_13[0]', '6e'), #"Reserved for future use"
            TextPDFField('topmostSubform[0].Page1[0].f1_14[0]', '6f'),
            TextPDFField('topmostSubform[0].Page1[0].f1_15[0]', '6g'),
            TextPDFField('topmostSubform[0].Page1[0].f1_16[0]', '6h'),
            TextPDFField('topmostSubform[0].Page1[0].f1_17[0]', '6i'),
            TextPDFField('topmostSubform[0].Page1[0].f1_18[0]', '6j'),
            TextPDFField('topmostSubform[0].Page1[0].f1_19[0]', '6k'),
            TextPDFField('topmostSubform[0].Page1[0].f1_20[0]', '6l'),
            TextPDFField('topmostSubform[0].Page1[0].f1_21[0]', '6m'),
            TextPDFField('topmostSubform[0].Page1[0].Line6z_ReadOrder[0].f1_22[0]', '6z_type'),
            TextPDFField('topmostSubform[0].Page1[0].Line6z_ReadOrder[0].f1_23[0]', '6z_type'),
            TextPDFField('topmostSubform[0].Page1[0].f1_24[0]', '6z'),
            TextPDFField('topmostSubform[0].Page1[0].f1_25[0]', '7'),
            TextPDFField('topmostSubform[0].Page1[0].f1_26[0]', '8'),
...
#            TextPDFField('topmostSubform[0].Page2[0].f2_07[0]', '13c'),
#            TextPDFField('topmostSubform[0].Page2[0].f2_08[0]', '13b'),
#            TextPDFField('topmostSubform[0].Page2[0].f2_10[0]', '13d'),
#            TextPDFField('topmostSubform[0].Page2[0].Line13z_ReadOrder[0].f2_14[0]', '13_type'),
