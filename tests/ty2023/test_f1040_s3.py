...
class Form1040S3TestCase(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2023.available_forms, input_fixture='tests/ty2023/fixtures/f1040_s3_0.habutax', values=values)
...
class Form1040S3TestCaseTooManyForeignTaxesSingle(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2023.available_forms, input_fixture='tests/ty2023/fixtures/f1040_s3_0.habutax', inputs=inputs, values=values)
