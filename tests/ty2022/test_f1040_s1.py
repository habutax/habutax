...
class Form1040S1TestCase0(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2022.available_forms, input_fixture='tests/ty2022/fixtures/f1040_s1_0.habutax', values=values)
...
class Form1040S1TestCase1(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2022.available_forms, input_fixture='tests/ty2022/fixtures/f1040_s1_1.habutax')
...
class Form1040S1TestCase1_no_hsa(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2022.available_forms, input_fixture='tests/ty2022/fixtures/f1040_s1_1.habutax', inputs=inputs)
...
class Form1040S1TestCase1_you_hsa(FormTestCase):
    def setUp(self):
        ...
        self.fixture_setup(ty2022.available_forms, input_fixture='tests/ty2022/fixtures/f1040_s1_1.habutax', inputs=inputs, values=values)
